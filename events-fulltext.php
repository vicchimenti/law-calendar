...
/* Version 2.2 */
  ...
  /* Start Catch */
    ...
    echo '<!--'.$e->getMessage().'-->';
    ?>
    <time class="sdate" datetime="<t4 type="content" name="Start Date and Time" date_format="yyyy-d-MM" output="normal" />"><t4 type="content" name="Start Date and Time" date_format="MMMM d, yyyy" output="normal" modifiers=""  /></time><span class="to-date sr-only"> to <time datetime="<t4 type="content" name="End Date and Time" date_format="yyyy-d-MM" output="normal" />"><t4 type="content" name="End Date and Time" date_format="MMMM d, yyyy" output="normal" modifiers=""  /></time></span> - <a href="#location-map"><t4 type="content" name="Venue" output="normal" modifiers="striptags"  /></a>
    <?php
}
/* End Catch */
?>
